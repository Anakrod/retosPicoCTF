...
HINT1: There are tools that make this easy.
...
Nos conectamos a la liga que nos da, y nos da un texto en 'vigenere', pero no tenemos la bandera, utilizamos CyberChef para decodificarlo y en este caso intentamos algunas llaves, y encontramos que 'flag' es la llave, decodificamos y encontramos la bandera.
```
## Referencias
```
